...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        Object[] first = {"gugu", "제목1", "내용1"};
        Object[] second = {2, "gugu", "제목2", "내용2", new Date(), 1};
        final Question firstQuestion = (Question) firstConstructor.newInstance(first);
        final Question secondQuestion = (Question) secondConstructor.newInstance(second);
